                ...
                <div className='container mx-auto px-4 pt-6 pb-[200px] relative z-10'>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        ...
                        <div className='w-full md:w-1/2'>
                            <p className='text-[16px] text-gray-900 mr-0 md:mr-20 mb-6'>
                                Get role specific questions, expand answrs when you need them, div deeper into concepts, and organize everything your way, From preparation to mastery - your ultimate interview toolkit is here.
                            </p>
